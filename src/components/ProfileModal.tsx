                ...
                <form onSubmit={handleSave} className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-2xl text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/50 transition-all font-medium"
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-indigo-400/70 italic px-1 mt-1 font-medium">Nota: Se alterar o e-mail, uma confirmação será enviada.</p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 pt-4 border-t border-white/5">
                        ...
                        <button
                            ...
                            className="flex-1 py-3.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-2xl transition-all shadow-lg shadow-indigo-600/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
